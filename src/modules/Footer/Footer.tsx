...
import style from './Footer.module.scss'; // Import SCSS module

export const Footer: React.FC = () => {
  return (
    <footer className={style.footer}>
      <div className={`container ${style.footer__container}`}>
        <a className={style.footer__logo_link} href="#">
          <img src="image/logo.svg" alt="Cup Time" className={style.footer__logo} />
        </a>
        <div className={style.footer__nav}>
          <ul className={`${style.footer__menu} ${style.flex__container}`}>
            <li className={style.footer__menu_item}>
              <a className={style.footer__menu_link} href="#">Чай</a>
            </li>
            <li className={style.footer__menu_item}>
              <a className={style.footer__menu_link} href="#">Кофе</a>
            </li>
            <li className={style.footer__menu_item}>
              <a className={style.footer__menu_link} href="#">Чайники</a>
            </li>
            <li className={style.footer__menu_item}>
              <a className={style.footer__menu_link} href="#">Турки</a>
            </li>
            <li className={style.footer__menu_item}>
              <a className={style.footer__menu_link} href="#">Прочее</a>
            </li>
          </ul>
        </div>

        <div className={style.footer__info}>
          <p className={style.footer__copyright}>@CUPTIME, 2024</p>
        ...
        <div className={style.footer__contacts}>
          <a href="mailto:CUPTIME@gmail.com" className={style.footer__email}>CUPTIME@gmail.com</a>
          <ul className={style.footer__social}>
            <li className={style.footer__social_item}>
              <a className={style.footer__social_link} href="#">
