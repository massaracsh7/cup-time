            ...
            <ul className="products__list">
              <li className="products__item">
                <article className="product">
                  <img src="image/photo-2.jpg" alt="Кокосовая матча" className="product__image" />
                    <div className="product__content">
                      <h3 className="product__title">Кокосовая матча</h3>
                      <p className="product__price">390 ₽</p></div>
                </article>
              </li>
              <li className="products__item">
                <article className="product">
                  <img src="image/photo-3.jpg" alt="Зеленый индонезийский чай" className="product__image" />
                    <div className="product__content"><h3 className="product__title">Зеленый индонезийский чай</h3>
                      <p className="product__price">340 ₽</p></div>
                </article>
              </li>
              <li className="products__item">
                <article className="product">
                  <img src="image/photo-4.jpg" alt="Черный чай из Эфиопии" className="product__image" />
                    <div className="product__content"><h3 className="product__title">Черный чай из Эфиопии</h3>
                      <p className="product__price">380 ₽</p></div>
                </article>
              </li>
              <li className="products__item">
                <article className="product">
                  <img src="image/photo-5.jpg" alt="Черный чай из Калифорнии" className="product__image" />
                    <div className="product__content"><h3 className="product__title">Черный чай из Калифорнии</h3>
                      <p className="product__price">360 ₽</p></div>
                </article>
              </li>
              <li className="products__item">
                <article className="product">
                  <img src="image/photo-6.jpg" alt="Органическая веганская матча" className="product__image" />
                    <div className="product__content"><h3 className="product__title">Органическая веганская матча</h3>
                      <p className="product__price">400 ₽</p></div>
                </article>
              </li>
              <li className="products__item">
                <article className="product">
                  <img src="image/photo-7.jpg" alt="Чай черный Лакандона" className="product__image" />
                    <div className="product__content"><h3 className="product__title">Чай черный Лакандона</h3>
                      <p className="product__price">390 ₽</p></div>
                </article>
              </li>
            </ul>
      ...
      <footer className="footer">
        <div className="container footer__container">
          <a className="footer__logo-link">
            <img src="image/logo.svg" alt="Cup Time" className="footer__logo" />
          </a>
          <div className="footer__nav">
            <ul className="footer__menu flex__container">
